                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('sms-campaigns.show', $smsCampaign) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="@lang('View')"><i class="fa fa-list apexdent-padding-btn"></i></a>&nbsp;&nbsp;
                                @endif
                                <a href="#" data-href="{{ route('sms-campaigns.destroy', $smsCampaign) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="@lang('Delete')"><i class="fa fa-trash apexdent-padding-btn"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
