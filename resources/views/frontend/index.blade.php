...
<head>
	...
	<title>{{ $ApplicationSetting->item_name }} | @lang('Home') </title>
	<!-- Font Awesome Icons -->
			...
			<div class="history-info position-relative">
				...
				<div class="position-relative">
					...
					<div id="small-dialog" class="zoom-anim-dialog mfp-hide">
						<iframe src="https://www.youtube.com/embed/jdTmkKE621E" title="ApexDent Kalmunai" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
					</div>
				</div>
			</div>
		</div>
