            ...
            <div class="card-body">
                <form class="form-material form-horizontal" action="{{ route('invoices.update', $invoice) }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>@lang('Invoice Date') <b class="apexdent-crimson">*</b></label>
                            ...
                            <div class="table-responsive">
                                <table id="t1" class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td colspan="3"></td>
                                            <td class="apexdent-right">@lang('Total')</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td colspan="3"></td>
                                            <td class="apexdent-right">@lang('Grand Total')</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td colspan="3"></td>
                                            <td class="apexdent-right">@lang('Paid')</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td colspan="3"></td>
                                            <td class="apexdent-right">@lang('Due')</td>
                                            <td>
