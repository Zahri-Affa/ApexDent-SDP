            ...
            <div class="card-body">
                <form id="emailCampaignForm" class="form-material form-horizontal" action="{{ route('email-campaigns.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="campaign_name">@lang('Campaign Name') <b class="apexdent-crimson">*</b></label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="contact_type">@lang('Select Group') <b class="apexdent-crimson">*</b></label>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="message">@lang('Message') <b class="apexdent-crimson">*</b></label>
                                <br>
