                        ...
                        <tbody>
                            @foreach ($payments as $payment)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('payments.show', $payment) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="@lang('View')"><i class="fa fa-eye apexdent-padding-btn"></i></a>&nbsp;&nbsp;
                                        @can('payment-update')
                                            <a href="{{ route('payments.edit', $payment) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="@lang('Edit')"><i class="fa fa-edit apexdent-padding-btn"></i></a>&nbsp;&nbsp;
                                        @endcan
                                        @can('payment-delete')
                                            <a href="#" data-href="{{ route('payments.destroy', $payment) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="@lang('Delete')"><i class="fa fa-trash apexdent-padding-btn"></i></a>
                                        @endcan
                                    </td>
                                </tr>
                            @endforeach
