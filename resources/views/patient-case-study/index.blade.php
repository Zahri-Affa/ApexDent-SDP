                        ...
                        <tbody>
                            @foreach ($patientCaseStudy as $patientDetail)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('patient-case-studies.show', $patientDetail) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="@lang('View')"><i class="fa fa-eye apexdent-padding-btn"></i></a>&nbsp;&nbsp;
                                        @can('patient-case-studies-update')
                                            <a href="{{ route('patient-case-studies.edit', $patientDetail) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="@lang('Edit')"><i class="fa fa-edit apexdent-padding-btn"></i></a>&nbsp;&nbsp;
                                        @endcan
                                        @can('patient-case-studies-delete')
                                            <a href="#" data-href="{{ route('patient-case-studies.destroy', $patientDetail) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="@lang('Delete')"><i class="fa fa-trash apexdent-padding-btn"></i></a>
                                        @endcan
                                    </td>
                                </tr>
                            @endforeach
