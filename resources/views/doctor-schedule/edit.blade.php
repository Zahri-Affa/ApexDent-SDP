...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form id="scheduleForm" class="form-material form-horizontal" action="{{ route('doctor-schedules.update', $doctorSchedule) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                            <label for="user_id">@lang('Select Doctor') <b class="apexdent-crimson">*</b></label>
                            <div class="form-group input-group mb-3">
                                ...
                                <select name="user_id" class="form-control select2 @error('user_id') is-invalid @enderror" id="user_id" required>
                                    ...
                                    @foreach ($doctors as $doctor)
                                        <option value="{{ $doctor->id }}" {{ old('user_id', $doctorSchedule->user_id) == $doctor->id ? 'selected' : '' }}>{{ $doctor->name }}</option>
                                    @endforeach
                                </select>
                                @error('user_id')
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                            <label for="weekday">@lang('Select Weekday') <b class="apexdent-crimson">*</b></label>
                            <div class="form-group input-group mb-3">
                                <div class="input-group-prepend">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="start_time">@lang('Start Time') <b class="apexdent-crimson">*</b></label>
                                <div class="form-group input-group mb-3">
                                    <div class="input-group-prepend">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="end_time">@lang('End Time') <b class="apexdent-crimson">*</b></label>
                                <div class="form-group input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fas fa-clock"></i></span>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="avg_appointment_duration">@lang('Avg Appointment Duration') (@lang('minute')) <b class="apexdent-crimson">*</b></label>
                                <div class="form-group input-group mb-3">
                                    <div class="input-group-prepend">
                                    ...
                                    <select class="form-control @error('avg_appointment_duration') is-invalid @enderror" name="avg_appointment_duration" id="avg_appointment_duration" required>
                                        @foreach (config('constant.avg_appointment_durations') as $duration)
                                            <option value="{{ $duration }}" {{ old('avg_appointment_duration', $doctorSchedule->avg_appointment_duration) == $duration ? 'selected' : '' }}>{{ $duration }}</option>
                                        @endforeach
                                    </select>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="serial_type">@lang('Serial Type') <b class="apexdent-crimson">*</b></label>
                                <div class="form-group input-group mb-3">
                                    <div class="input-group-prepend">
                                    ...
                                    <select class="form-control @error('serial_type') is-invalid @enderror" name="serial_type" id="serial_type" required>
                                        ...
                                        <option value="Timestamp" {{ old('serial_type', $doctorSchedule->serial_type) == 'Timestamp' ? 'selected' : '' }}>@lang('Timestamp')</option>
                                    </select>
                                    @error('serial_type')
                                        <div class="invalid-feedback">
                                            {{ $message }}
