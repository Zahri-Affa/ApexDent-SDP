                        ...
                        <div class="row">
                            <div class="col-md-4 description_padding_left">
                                <div class="form-group">
                                    <label class="col-md-12 col-form-label">@lang('Annual Check-ups') <b class="apexdent-crimson">*</b></label>
                                    <div class="col-md-12">
                            ...
                            <div class="col-md-4 description_padding_left">
                                <div class="form-group">
                                    <label class="col-md-12 col-form-label">@lang('Help at Hand') <b class="apexdent-crimson">*</b></label>
                                    <div class="col-md-12">
