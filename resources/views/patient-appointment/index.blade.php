                        ...
                        <tbody>
                            @foreach ($patientAppointments as $patientAppointment)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('patient-appointments.show', $patientAppointment) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="@lang('View')"><i class="fa fa-eye apexdent-padding-btn"></i></a>&nbsp;&nbsp;
                                        @can('doctor-schedule-delete')
                                            <a href="#" data-href="{{ route('patient-appointments.destroy', $patientAppointment) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="@lang('Delete')"><i class="fa fa-trash apexdent-padding-btn"></i></a>
                                        @endcan
                                    </td>
                                </tr>
                            @endforeach
