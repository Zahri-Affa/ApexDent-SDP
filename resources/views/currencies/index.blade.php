                        ...
                        <tr>
                            ...
                            <td>
                                @can('currencies-update')
                                    <a href="{{ route('currency.edit', $currency) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="@lang('Edit')"><i class="fa fa-edit apexdent-padding-btn"></i></a>&nbsp;&nbsp;
                                @endcan
                                @can('currencies-delete')
                                    <a href="#" data-href="{{ route('currency.destroy', $currency) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="@lang('Delete')"><i class="fa fa-trash apexdent-padding-btn"></i></a>
                                @endcan
                            </td>
                        </tr>
                    @endforeach
