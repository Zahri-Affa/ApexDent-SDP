                ...
                <form id="departmentForm" class="form-material form-horizontal" action="{{ route('front-ends.updateHome', $frontEnd) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-4 description_padding_left">
                                <div class="form-group">
                                    <label class="col-md-12 col-form-label">@lang('Header Top Address') <b class="apexdent-crimson">*</b></label>
                                    <div class="col-md-12">
                            ...
                            <div class="col-md-4 description_padding_left">
                                <div class="form-group">
                                    <label class="col-md-12 col-form-label">@lang('Header Top Email') <b class="apexdent-crimson">*</b></label>
                                    <div class="col-md-12">
                            ...
                            <div class="col-md-4 description_padding_left">
                                <div class="form-group">
                                    <label class="col-md-12 col-form-label">@lang('Header question call') <b class="apexdent-crimson">*</b></label>
                                    <div class="col-md-12">
                    ...
                    <fieldset class="custom-fieldset-padding-border-radius">
                        ...
                        <div class="row">
                            <div class="col-md-6 description_padding_left">
                                <div class="form-group">
                                    <label class="col-md-12 col-form-label">@lang('Head Line') <b class="apexdent-crimson">*</b></label>
                                    <div class="col-md-12">
                            ...
                            <div class="col-md-6 description_padding_left">
                                <div class="form-group">
                                    <label class="col-md-12 col-form-label">@lang('Tag Line') <b class="apexdent-crimson">*</b></label>
                                    <div class="col-md-12">
                    ...
                    <fieldset class="custom-fieldset-padding-border-radius">
                        ...
                        <div class="row">
                            <div class="col-md-12 description_padding_left">
                                <div class="form-group">
                                    <label class="col-md-12 col-form-label">@lang('We are Here Welcome text') <b class="apexdent-crimson">*</b></label>
                                    <div class="col-md-12">
                            ...
                            <div class="col-md-6 description_padding_left">
                                <div class="form-group">
                                    <label class="col-md-12 col-form-label">@lang('Welcome text description one') <b class="apexdent-crimson">*</b></label>
                                    <div class="col-md-12">
                            ...
                            <div class="col-md-6 description_padding_left">
                                <div class="form-group">
                                    <label class="col-md-12 col-form-label">@lang('Welcome text description two') <b class="apexdent-crimson">*</b></label>
                                    <div class="col-md-12">
                    ...
                    <fieldset class="custom-fieldset-padding-border-radius">
                        ...
                        <div class="row">
                            <div class="col-md-4 description_padding_left">
                                <div class="form-group">
                                    <label class="col-md-12 col-form-label">@lang('Heading') <b class="apexdent-crimson">*</b></label>
                                    <div class="col-md-12">
                            ...
                            <div class="col-md-4 description_padding_left">
                                <div class="form-group">
                                    <label class="col-md-12 col-form-label">@lang('Daily appointments count') <b class="apexdent-crimson">*</b></label>
                                    <div class="col-md-12">
                            ...
                            <div class="col-md-4 description_padding_left">
                                <div class="form-group">
                                    <label class="col-md-12 col-form-label">@lang('Happy clients count') <b class="apexdent-crimson">*</b></label>
                                    <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-4 description_padding_left">
                                <div class="form-group">
                                    <label class="col-md-12 col-form-label">@lang('For a New smile discription') <b class="apexdent-crimson">*</b></label>
                                    <div class="col-md-12">
                            ...
                            <div class="col-md-4 description_padding_left">
                                <div class="form-group">
                                    <label class="col-md-12 col-form-label">@lang('Daily appointments discription') <b class="apexdent-crimson">*</b></label>
                                    <div class="col-md-12">
                            ...
                            <div class="col-md-4 description_padding_left">
                                <div class="form-group">
                                    <label class="col-md-12 col-form-label">@lang('Happy Clients discription') <b class="apexdent-crimson">*</b></label>
                                    <div class="col-md-12">
                    ...
                    <fieldset class="custom-fieldset-padding-border-radius">
                        ...
                        <div class="row">
                            <div class="col-md-12 description_padding_left">
                                <div class="form-group">
                                    <label class="col-md-12 col-form-label">@lang('Bottom Tag Line') <b class="apexdent-crimson">*</b></label>
                                    <div class="col-md-12">
                        ...
                        <fieldset class="custom-fieldset-padding-border-radius">
                            ...
                            <div class="row">
                                <div class="col-md-4 description_padding_left">
                                    <div class="form-group">
                                        <label class="col-md-12 col-form-label">@lang('Facebook') <b class="apexdent-crimson">*</b></label>
                                        <div class="col-md-12">
                                ...
                                <div class="col-md-4 description_padding_left">
                                    <div class="form-group">
                                        <label class="col-md-12 col-form-label">@lang('Twitter') <b class="apexdent-crimson">*</b></label>
                                        <div class="col-md-12">
                                ...
                                <div class="col-md-4 description_padding_left">
                                    <div class="form-group">
                                        <label class="col-md-12 col-form-label">@lang('Google') <b class="apexdent-crimson">*</b></label>
                                        <div class="col-md-12">
                        ...
                        <fieldset class="custom-fieldset-padding-border-radius">
                            ...
                            <div class="row">
                                <div class="col-md-3 description_padding_left">
                                    <div class="form-group">
                                        <label class="col-md-12 col-form-label">@lang('Monday') <b class="apexdent-crimson">*</b></label>
                                        <div class="col-md-12">
                                ...
                                <div class="col-md-3 description_padding_left">
                                    <div class="form-group">
                                        <label class="col-md-12 col-form-label">@lang('Tuesday') <b class="apexdent-crimson">*</b></label>
                                        <div class="col-md-12">
                                ...
                                <div class="col-md-3 description_padding_left">
                                    <div class="form-group">
                                        <label class="col-md-12 col-form-label">@lang('Wednesday') <b class="apexdent-crimson">*</b></label>
                                        <div class="col-md-12">
                                ...
                                <div class="col-md-3 description_padding_left">
                                    <div class="form-group">
                                        <label class="col-md-12 col-form-label">@lang('Thursday') <b class="apexdent-crimson">*</b></label>
                                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-3 description_padding_left">
                                    <div class="form-group">
                                        <label class="col-md-12 col-form-label">@lang('Friday') <b class="apexdent-crimson">*</b></label>
                                        <div class="col-md-12">
                                ...
                                <div class="col-md-3 description_padding_left">
                                    <div class="form-group">
                                        <label class="col-md-12 col-form-label">@lang('Saturday') <b class="apexdent-crimson">*</b></label>
                                        <div class="col-md-12">
                                ...
                                <div class="col-md-3 description_padding_left">
                                    <div class="form-group">
                                        <label class="col-md-12 col-form-label">@lang('Sunday') <b class="apexdent-crimson">*</b></label>
                                        <div class="col-md-12">
