...
<div id="wrapper">
    <div id="page-wrapper" class="custom-page-wrapper-my">
        <div class="container-fluid">
            ...
            <br>
            <div class="row apexdent-padding-left-right">
                <div class="col-sm-12 col-xs-12 col-md-7 col-lg-7 border_gray grid_content padded background_white alert">
                    <h2 class="column-title"><i class="fas fa-cog"></i> Install apexdent</h2>
                    <hr>
                    <br>
                    ...
                    <div class="account-wall install-text-left" id='recovery_form'>
                        <form class="form-material form-horizontal" action="{{ route('install.install') }}" method="POST">
                            ...
                            <div class="form-group">
                                <label>App URL *</label>
                                <input type="text" value="{{ old('app_url') }}" name="app_url" required class="form-control apexdent-form-loading @error('app_url') is-invalid @enderror col-xs-12"  placeholder="App URL *" pattern="https?://.+">
                                @error('app_url')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ old('host_name') }}" name="host_name" required class="form-control apexdent-form-loading @error('host_name') is-invalid @enderror col-xs-12"  placeholder="Host Name *">
                                @error('host_name')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ old('database_name') }}" name="database_name" required class="form-control apexdent-form-loading @error('database_name') is-invalid @enderror col-xs-12"  placeholder="Database Name *">
                                @error('database_name')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ old('database_port') }}" name="database_port" required class="form-control apexdent-form-loading @error('database_port') is-invalid @enderror col-xs-12"  placeholder="Database Port *" pattern="[0-9]+">
                                @error('database_port')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ old('database_username') }}" name="database_username" required class="form-control apexdent-form-loading @error('database_username') is-invalid @enderror col-xs-12"  placeholder="Database Username *">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ old('database_password') }}" name="database_password" class="form-control apexdent-form-loading @error('database_password') is-invalid @enderror col-xs-12"  placeholder="Database Password">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ old('name') }}" name="name" class="form-control apexdent-form-loading @error('name') is-invalid @enderror col-xs-12"  placeholder="Admin Name" required>
                                @error('name')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" value="{{ old('email') }}" name="email" class="form-control apexdent-form-loading @error('email') is-invalid @enderror col-xs-12"  placeholder="Admin Email" required>
                                @error('email')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" value="{{ old('password') }}" name="password" class="form-control apexdent-form-loading @error('password') is-invalid @enderror col-xs-12"  placeholder="Admin Password" required>
                                @error('password')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group text-center">
                                <button type="submit" class="btn btn-warning btn-lg install-margin-top" <?php if($install_allow == 0) echo "disabled"; ?> ><i class="fa fa-check" ></i> Install apexdent Now</button><br/><br/>
                            </div>
                        </form>
                    </div>
                </div>
