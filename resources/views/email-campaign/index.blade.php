                        ...
                        <tr>
                            ...
                            <td>
                                @if($emailCampaign->status == 'Completed')
                                    <a href="{{ route('email-campaigns.show', $emailCampaign) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="@lang('View')"><i class="fa fa-list apexdent-padding-btn"></i></a>&nbsp;&nbsp;
                                @endif
                                <a href="#" data-href="{{ route('email-campaigns.destroy', $emailCampaign) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="@lang('Delete')"><i class="fa fa-trash apexdent-padding-btn"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
