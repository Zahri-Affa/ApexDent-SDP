<!-- alertify CSS -->
<link href="{{ asset('assets/plugins/alertifyjs/css/alertify.min.css') }}" rel="stylesheet">
<link href="{{ asset('assets/plugins/alertifyjs/css/themes/default.min.css') }}" rel="stylesheet">
<link href="{{ asset('assets/plugins/alertifyjs/css/themes/semantic.min.css') }}" rel="stylesheet">
...
<!-- apexdent CSS -->
<link href="{{ asset('assets/css/apexdent.css') }}" rel="stylesheet">
