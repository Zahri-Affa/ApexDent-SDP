                            ...
                            <div class="row">
                                <div class="col-md-12 description_padding_left">
                                    <div class="form-group">
                                        <label class="col-md-12 col-form-label">@lang('Description') <b class="apexdent-crimson">*</b></label>
                                        <div class="col-md-12">
                        ...
                        <fieldset class="custom-fieldset-padding-border-radius">
                            ...
                            <div class="row">
                                <div class="col-md-6 description_padding_left">
                                    <div class="form-group">
                                        <label class="col-md-12 col-form-label">@lang('Free Check Up') <b class="apexdent-crimson">*</b></label>
                                        <div class="col-md-12">
                                ...
                                <div class="col-md-6 description_padding_left">
                                    <div class="form-group">
                                        <label class="col-md-12 col-form-label">@lang('Always Open') <b class="apexdent-crimson">*</b></label>
                                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-6 description_padding_left">
                                    <div class="form-group">
                                        <label class="col-md-12 col-form-label">@lang('Serve with Smile') <b class="apexdent-crimson">*</b></label>
                                        <div class="col-md-12">
                                ...
                                <div class="col-md-6 description_padding_left">
                                    <div class="form-group">
                                        <label class="col-md-12 col-form-label">@lang('Work with Hearts') <b class="apexdent-crimson">*</b></label>
                                        <div class="col-md-12">
