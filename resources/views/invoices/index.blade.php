                        ...
                        <tbody>
                            @foreach ($invoices as $invoice)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('invoices.show', $invoice) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="@lang('View')"><i class="fa fa-eye apexdent-padding-btn"></i></a>&nbsp;&nbsp;
                                        @can('invoice-update')
                                            <a href="{{ route('invoices.edit', $invoice) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="@lang('Edit')"><i class="fa fa-edit apexdent-padding-btn"></i></a>&nbsp;&nbsp;
                                        @endcan
                                        @can('invoice-delete')
                                            <a href="#" data-href="{{ route('invoices.destroy', $invoice) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="@lang('Delete')"><i class="fa fa-trash apexdent-padding-btn"></i></a>
                                        @endcan
                                    </td>
                                </tr>
                            @endforeach
