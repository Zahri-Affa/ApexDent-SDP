                ...
                <div class="card-body">
                    <form id="departmentForm" class="form-material form-horizontal" action="{{ route('doctor-details.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="email">@lang('Email') <b class="apexdent-crimson">*</b></label>
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="password">@lang('Password') <b class="apexdent-crimson">*</b></label>
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="hospital_department_id">@lang('Select Department') <b class="apexdent-crimson">*</b></label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="form-control apexdent-form-loading @error('status') is-invalid @enderror" required name="status" id="status">
