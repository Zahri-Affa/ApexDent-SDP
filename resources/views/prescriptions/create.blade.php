            ...
            <div class="card-body">
                <form class="form-material form-horizontal" action="{{ route('prescriptions.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>@lang('Prescription Date') <b class="apexdent-crimson">*</b></label>
...
<!--                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="weight">@lang('Weight (kg)') <b class="apexdent-crimson">*</b></label>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="height">@lang('Height (feet)') <b class="apexdent-crimson">*</b></label>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="blood_pressure">@lang('Blood Pressure') <b class="apexdent-crimson">*</b></label>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fas fa-tint"></i></span>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="chief_complaint">@lang('Chief Complaint') <b class="apexdent-crimson">*</b></label>
                                <div class="input-group mb-3">
