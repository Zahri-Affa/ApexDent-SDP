                            ...
                            <div class="card-body">
                                <form class="form-material form-horizontal" action="{{ route('general') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <label for="exampleInputPassword1">@lang('Company') <b class="apexdent-crimson">*</b></label>
                                            ...
                                            <div class="col-md-6">
                                                <label for="exampleInputPassword1">@lang('Email') <b class="apexdent-crimson">*</b></label>
                                                <div class="form-group input-group mb-3">
                                                    <div class="input-group-prepend">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <label>{{ __('Address') }} <b class="apexdent-crimson">*</b></label>
