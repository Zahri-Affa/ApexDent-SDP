...
<head>
	...
	<title>{{ $ApplicationSetting->item_name }} | @lang('Services') </title>
	<!-- Font Awesome Icons -->
		...
		<div class="features4-block py-5">
			<div class="container py-lg-5">
				<div class="title-content text-left mb-lg-5 mt-4">
					...
					<h3 class="hny-title two">@lang('Enhanced Features of Our Clinic')</h3>
				...
				<div class="row features4-grids text-left">
					<div class="col-lg-3 col-md-6 features4-grid">
						<div class="features4-grid-inn">
							...
							<h5><a href="#URL">@lang('Complimentary Initial Consultation')</a></h5>
							<p>{{ $contents->check ?? '' }}</p>
					...
					<div class="col-lg-3 col-md-6 features4-grid">
						<div class="features4-grid-inn">
							...
							<h5><a href="#URL">@lang('Convenient Hours, Always Here for You')</a></h5>
							<p>{{ $contents->open ?? '' }}</p>
					...
					<div class="col-lg-3 col-md-6 features4-grid">
						<div class="features4-grid-inn">
							...
							<h5><a href="#URL">@lang('Passion for Care')</a></h5>
							<p>{{ $contents->work ?? '' }}</p>
