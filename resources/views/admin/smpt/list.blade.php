                ...
                <tbody>
                    @foreach ($lists as $list)
                        <tr>
                            ...
                            <td>
                                @can('smtp-update')
                                    <a href="{{ route('smtp-configurations.edit', $list) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="@lang('Edit')"><i class="fa fa-edit apexdent-padding-btn"></i></a>&nbsp;&nbsp;
                                @endcan
                                @can('smtp-delete')
                                    <a href="#" data-href="{{ route('smtp-configurations.destroy', $list) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="@lang('Delete')"><i class="fa fa-trash apexdent-padding-btn"></i></a>
                                @endcan
                            </td>
                        </tr>
                    @endforeach
