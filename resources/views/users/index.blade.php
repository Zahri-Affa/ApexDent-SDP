                    ...
                    <tbody>
                        @foreach ($users as $user)
                            <tr>
                                ...
                                <td>
                                    @can('user-update')
                                        <a href="{{ route('users.edit', $user->id) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="@lang('Edit')"><i class="fa fa-edit apexdent-padding-btn"></i></a>&nbsp;&nbsp;
                                    @endcan
                                    @can('user-delete')
                                    <a href="#" data-href="{{ route('users.destroy', $user->id) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="@lang('Delete')"><i class="fa fa-trash apexdent-padding-btn"></i></a>
                                    @endcan
                                </td>
                            </tr>
                        @endforeach
