                ...
                <form class="form-material form-horizontal" action="{{ route('company.update', $company) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <input class="form-control apexdent-form-loading @error('company_name') is-invalid @enderror" name="company_name" id="company_name" type="text" value="{{ old('company_name',$company->company_name) }}" placeholder="{{ __('Enter Name') }}" required>
                                @error('company_name')
                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <input class="form-control apexdent-form-loading @error('company_email') is-invalid @enderror" name="company_email" id="company_email" type="email" value="{{ old('company_email', $company->company_email) }}" placeholder="{{ __('Enter Company Email') }}" required>
                                @error('company_email')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <input class="form-control apexdent-form-loading @error('domain') is-invalid @enderror" name="domain" id="domain" type="text" value="{{ old('domain', $company->domain) }}" placeholder="{{ __('Enter Domain') }}" required>
                                @error('domain')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <select class="form-control apexdent-form-loading" name="enabled" id="enabled">
