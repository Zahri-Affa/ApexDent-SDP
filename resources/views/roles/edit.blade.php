                ...
                <div class="card-body">
                    <form class="form-material form-horizontal" action="{{ route('roles.update', $role) }}" method="POST">
                        ...
                        <div class="form-group row mb-0">
                            <label class="col-md-2 col-form-label apexdent-center"><h4 class="apexdent-role-margin apexdent-center">@lang('Role Name') <b class="apexdent-crimson">*</b></h4></label>
                            <div class="col-md-8">
                                <input class="form-control apexdent-form-loading @error('name') is-invalid @enderror" name="name" id="name" type="text" placeholder="@lang('Role Name')" value="{{ old('name', $role->name) }}" >
                                @error('name')
                        ...
                        <div id="user_block">
                            <div class="form-group row mb-0">
                                <label class="col-md-2 col-form-label apexdent-center"><h4 class="apexdent-role-margin">@lang('Price') <b class="apexdent-crimson">*</b></h4></label>
                                <div class="col-md-8">
                                    <input class="form-control apexdent-form-loading @error('price') is-invalid @enderror" name="price" id="price" type="text" placeholder="@lang('Role Price')" value="{{ old('price', $role->price) }}">
                                    @error('price')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="form-group row mb-0">
                                <label class="col-md-2 col-form-label apexdent-center"><h4 class="apexdent-role-margin">@lang('Validity Day') <b class="apexdent-crimson">*</b></h4></label>
                                <div class="col-md-8">
                                    <input class="form-control apexdent-form-loading @error('validity') is-invalid @enderror" name="validity" id="validity" type="text" placeholder="@lang('Validity Day')" value="{{ old('validity', $role->validity) }}" >
                                    @error('validity')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="form-group row mb-0">
                            <label class="col-md-2 col-form-label apexdent-center"><h4 class="apexdent-role-margin">@lang('Permissions')</h4></label>
                            <div class="col-md-10">
