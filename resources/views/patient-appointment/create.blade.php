            ...
            <div class="card-body">
                <form id="scheduleForm" class="form-material form-horizontal" action="{{ route('patient-appointments.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="user_id">@lang('Select Patient') <b class="apexdent-crimson">*</b></label>
                                <div class="form-group input-group mb-3">
                                    ...
                                    <select name="user_id" class="form-control select2 @error('user_id') is-invalid @enderror" id="user_id" required>
                                        ...
                                        @foreach ($patients as $patient)
                                            <option value="{{ $patient->id }}" {{ old('user_id') == $patient->id ? 'selected' : '' }}>{{ $patient->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('user_id')
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="doctor_id">@lang('Select Doctor') <b class="apexdent-crimson">*</b></label>
                                <div class="form-group input-group mb-3">
                                    <div class="input-group-prepend">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="appointment_date">@lang('Appointment Date') <b class="apexdent-crimson">*</b></label>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="far fa-calendar-check"></i></span>
                                    </div>
                                    <input type="text" name="appointment_date" id="appointment_date" class="form-control flatpickr @error('appointment_date') is-invalid @enderror" placeholder="@lang('Appointment Date')" value="{{ old('appointment_date') }}">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="appointment_slot">@lang('Available Appointment Slots') <b class="apexdent-crimson">*</b></label>
                                <div class="form-group input-group mb-3">
                                    <div class="input-group-prepend">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <textarea name="problem" id="problem" class="form-control @error('problem') is-invalid @enderror" rows="4" placeholder="@lang('Problem')">{{ old('problem') }}</textarea>
                                    @error('problem')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            ...
                            <a href="{{ route('patient-appointments.index') }}" class="btn btn-outline btn-warning btn-lg">{{ __('Cancel') }}</a>
                        </div>
                    </div>
                </form>
            </div>
