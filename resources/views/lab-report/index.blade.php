                ...
                <table class="table table-striped" id="laravel_datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('lab-reports.show', $labReport) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="@lang('View')"><i class="fa fa-eye apexdent-padding-btn"></i></a>&nbsp;&nbsp;
                                @can('lab-report-update')
                                    <a href="{{ route('lab-reports.edit', $labReport) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="@lang('Edit')"><i class="fa fa-edit apexdent-padding-btn"></i></a>&nbsp;&nbsp;
                                @endcan
                                @can('lab-report-delete')
                                    <a href="#" data-href="{{ route('lab-reports.destroy', $labReport) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="@lang('Delete')"><i class="fa fa-trash apexdent-padding-btn"></i></a>
                                @endcan
                            </td>
                        </tr>
                        @endforeach
