                    ...
                    <tbody>
                        @foreach ($taxes as $tax)
                            <tr>
                                ...
                                <td>
                                    @can('tax-rate-update')
                                        <a href="{{ route('tax.edit', $tax) }}" class="btn btn-info btn-circle" data-toggle="tooltip" title="@lang('Edit')"><i class="fa fa-edit apexdent-padding-btn"></i></a>&nbsp;&nbsp;
                                    @endcan
                                    @can('tax-rate-delete')
                                        <a href="#" data-href="{{ route('tax.destroy', $tax) }}" class="btn btn-info btn-circle" data-toggle="modal" data-target="#myModal" title="@lang('Delete')"><i class="fa fa-trash apexdent-padding-btn"></i></a>
                                    @endcan
                                </td>
                            </tr>
                        @endforeach
